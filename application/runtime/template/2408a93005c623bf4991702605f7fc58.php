        ...
        <div class="col-md-4 col-sm-6 main">
            <div class="panel panel-primary">
                ...
                <div style="padding: 10px;text-align: center;">
                    <form action="?" class="form-sign" method="post"><input type="hidden" name="do" value="add">
                        设置UID为<input type="text" style="width:50px;" name="uid">的会员为代理.<input type="submit" class="btn btn-primary" name="submit" value="设置">
                    </form>
