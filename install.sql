DROP TABLE IF EXISTS `mz_dailiconfigs`;
CREATE TABLE `mz_dailiconfigs` (
  `vkey` varchar(20) NOT NULL,
  `value` text,
  PRIMARY KEY (`vkey`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
DROP TABLE IF EXISTS `mz_kms`;
CREATE TABLE `mz_kms` (
...
DROP TABLE IF EXISTS `mz_mailcode`;
CREATE TABLE `mz_mailcode` (
...
DROP TABLE IF EXISTS `mz_webconfigs`;
CREATE TABLE `mz_webconfigs` (
  `vkey` varchar(255) NOT NULL,
  `value` text,
  PRIMARY KEY (`vkey`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
INSERT INTO `mz_dailiconfigs` VALUES ('daili_0vip', '80');
INSERT INTO `mz_dailiconfigs` VALUES ('daili_12vip', '60');
INSERT INTO `mz_dailiconfigs` VALUES ('daili_6vip', '40');
INSERT INTO `mz_dailiconfigs` VALUES ('daili_3vip', '20');
INSERT INTO `mz_dailiconfigs` VALUES ('daili_1vip', '8');
INSERT INTO `mz_dailiconfigs` VALUES ('daili_0peie', '66');
INSERT INTO `mz_dailiconfigs` VALUES ('daili_10peie', '20');
INSERT INTO `mz_dailiconfigs` VALUES ('daili_3peie', '10');
INSERT INTO `mz_dailiconfigs` VALUES ('daili_1peie', '5');
INSERT INTO `mz_webconfigs` VALUES ('adminpwd', '4d3ea8f0d1aa6fa07b6c0a5375645c48');
INSERT INTO `mz_webconfigs` VALUES ('web_name', '离线秒赞');
INSERT INTO `mz_webconfigs` VALUES ('web_domain', 'mz.qqsid.com');
INSERT INTO `mz_webconfigs` VALUES ('web_qq', '621019457');
INSERT INTO `mz_webconfigs` VALUES ('cronrand', '1234');
INSERT INTO `mz_webconfigs` VALUES ('web_wap_user_gg', '<p class="bg-warning" style="padding: 10px; font-size: 90%;">欢迎！<a target="_blank" href="/free.php">试用卡密自助获取</a>｜<a target="_blank" href="/pay/">平台VIP自助购买</a></p>
...
INSERT INTO `mz_webconfigs` VALUES ('web_www_user_gg', '<p class="bg-warning" style="padding: 10px; font-size: 90%;">欢迎！<a target="_blank" href="/free.php">试用卡密自助获取</a>｜<a target="_blank" href="/pay/">平台VIP自助购买</a></p>
<p class="bg-danger" style="padding: 10px; font-size: 90%;">最新售价：月卡10元 季卡20 半年卡35 年卡50 永久配额10元/个。</p>
<p class="bg-success" style="padding: 10px; font-size: 90%;">招收代理100 拿卡1折 搭建分站300</p>');
INSERT INTO `mz_webconfigs` VALUES ('regactive', '1');
INSERT INTO `mz_webconfigs` VALUES ('regpeie', '1');
INSERT INTO `mz_webconfigs` VALUES ('zannet', '4');
INSERT INTO `mz_webconfigs` VALUES ('freezan', '1');
INSERT INTO `mz_webconfigs` VALUES ('3gqqnet', '2');
INSERT INTO `mz_webconfigs` VALUES ('free3gqq', '2');
INSERT INTO `mz_webconfigs` VALUES ('replynet', '2');
INSERT INTO `mz_webconfigs` VALUES ('shuonet', '2');
INSERT INTO `mz_webconfigs` VALUES ('delnet', '1');
INSERT INTO `mz_webconfigs` VALUES ('qdnet', '1');
INSERT INTO `mz_webconfigs` VALUES ('zfnet', '1');
INSERT INTO `mz_webconfigs` VALUES ('netnum', '50');
INSERT INTO `mz_webconfigs` VALUES ('mail_email', '1000@qq.com');
INSERT INTO `mz_webconfigs` VALUES ('mail_pwd', '123456');
INSERT INTO `mz_webconfigs` VALUES ('mail_host', 'smtp.qq.com');
INSERT INTO `mz_webconfigs` VALUES ('mail_port', '25');